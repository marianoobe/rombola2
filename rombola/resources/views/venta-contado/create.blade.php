                    ...
                    <div class="row margenBoot-25">
                        <div class="col-xs-14 col-lg-6">
                            ...
                            <section id="buscar" style="display:none">
                                <select id="dnis" onchange="obtener_cliente_buscado()" class="selectpicker" data-live-search="true"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td align="center" style="cursor: default;">
                                                                    <input class="form-check-input" type="radio" change="check_lista_usados({{$item->dominio}})"
                            ...
                            <div class="row margenBoot-25">
                                <div class="col-xs-12 col-lg-10">
                                        <div class="form-group">
                                                ...
                                                <input type="text" id="valor_auto_vendido" maxlength="30" >
                                            </div>
                                    <div class="form-group">
                                        <label><strong>Valor de Auto Entregado</strong></label>
                                        <input type="number" id="valor_auto_entregado" maxlength="30" value="0">
                                    </div>
                                </div>
                            </div>
                            <div class="row margenBoot-25">
                                <div class="col-xs-12 col-lg-10">
                                    <div class="form-group">
                                        ...
                                        <input type="number" maxlength="30" id="inpefectivo" value="0">
                                    </div>
                                </div>
                            </div>
                            <div class="row margenBoot-25">
                                ...
                                <div class="col-xs-12 col-lg-7">
                                    <div class="form-group">
                                        <label><strong>Total</strong></label>
                                            ...
                                            <input type="number" id="restotal" style="display:none">
                                    </div>
                                </div>
                            </div>
                        </form>
                                        ...
                                        <div name="rows" class="row margenBoot-25">
                                            <div class="col-xs-12 col-lg-2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="banco" type="text" maxlength="150" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-lg-3">
                                                <div class="form-group">
                                                    <label><strong>Número</strong></label>
                                                    <input id="numero_cheque" type="text" maxlength="65" class="form-control" >
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date" name="date-fechaPagCheque[]">
                                                        <input id="fecha_cheque" type="text" class="form-control">
                                                        <span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span>
                                                        </span> </div>
                                                </div>
                                            </div>
